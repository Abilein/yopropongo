...
public class AllCouncilPresenter implements AllCouncilContract.Presenter {

    private CouncilService mService;
    private AllCouncilFragment mView;

    public AllCouncilPresenter(AllCouncilFragment mView, CouncilService mService) {
        this.mView = mView;
