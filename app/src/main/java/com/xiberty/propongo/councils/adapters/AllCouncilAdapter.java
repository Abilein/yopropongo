...
public class AllCouncilAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<DirectiveItem> items;
    private String TAG;

    public AllCouncilAdapter(Context context, ArrayList<DirectiveItem> items, String TAG) {
...
//        return 0;
    ...
    public View getView(final int position, View rowView, ViewGroup viewGroup) {
        ...
        if (pos == null || pos.equals(""))
            holder.position.setText("CONSEJAL");
        else
